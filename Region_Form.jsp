...
<jsp:useBean id="reg" scope="request" class="pack.Region"></jsp:useBean>
<%@page import="pack.*"%>
        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <form method="POST" style="padding-top:10px;" action="region_process.jsp">
                        ...
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="name" value="${reg.name}" required=""/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 50px;height: 30px" type="submit" name="op" value="${reg.op}" readonly="readonly" />
                                    </td>
                                </tr> 
                            </tbody>
                        </table>
                                    <a href="Region_View.jsp" style="color: #000">REGION VIEW</a>
                    </form>
                </center>
            </div>
            <!--
