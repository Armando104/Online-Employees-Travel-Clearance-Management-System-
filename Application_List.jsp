    ...
    <body>
        ...
        <tbody>
            <%
                ...
                List<Application> ll=Application.getList();
                
                int j = 0;
                while (j < ll.size()) {
                    int hh=ll.get(j).getApplicant_id();
                    Applicant at=Applicant.getApplicant_From_ID(hh);
            ...
            <tr>
                ...
                <td><%=at.getNames()%></td>
                <td><%=ll.get(j).getCV()%></td>
                <td><%=ll.get(j).getReg_Date()%></td>
                <td><%=ll.get(j).getStatus()%></td>
