        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <form method="POST" style="padding-top:10px;" action="battallionAction.jsp">
                      
                        <table border="0">
                            <tbody>
                                <input style="width: 200px;height: 18px" type="hidden" name="battallionId" value="${dd.battallionId}"/>
                                <tr>
                                    <td>
                                        <label>Name</label>
                                    </td>
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="battallion_name" value="${dd.battallion_name}" required=""/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="leader" value="${dd.leader}"  required=""/>
                                    </td>
                                </tr> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="location" value="${dd.location}" required=""/>
                                    </td>
                                </tr> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="battallion_members" value="${dd.battallion_members}"  required=""/>
                                    </td>
                                </tr>   
