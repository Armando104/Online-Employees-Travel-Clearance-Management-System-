    ...
    <body>
        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <table border="1">
                       <b> <h3><a href="Battallion_Form.jsp">Add New Battallion</a></h3></b>
        <thead>
            <tr>
                <th>BATTALLION ID</th>
                <th>BATTALLION NAME</th>
                <th>LEADER</th>
                <th>LOCATION</th>
                <th>MEMBERS</th>
        ...
        <tbody>
            <%
                ...
                List<Battallion> ll = Battallion.getBattallionList();
            ...
            %>
            <tr>
                <td><%=ll.get(j).getBattallion_id()%></td>
                <td><%=ll.get(j).getBattallion_name()%></td>
                <td><%=ll.get(j).getLeader()%></td>
                <td><%=ll.get(j).getLocation()%></td>
                <td><%=mem%></td>
                <td><a href="deleteBatt.jsp?id=<%=ll.get(j).getBattallion_id()%>">DELETE</a></td>
                <td><a href="editBatt.jsp?id=<%=ll.get(j).getBattallion_id()%>">EDIT</a></td>
