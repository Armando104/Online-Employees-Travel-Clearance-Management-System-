        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <form method="POST" style="padding-top:10px;" action="CV_Upload_Form.jsp" enctype="multipart/form-data">
                        ...
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                        ...
                                        <tr>
                                            <td><input type="file" name="CV" size="50" class="btn btn-navbar"/></td>
                                        </tr>                              
