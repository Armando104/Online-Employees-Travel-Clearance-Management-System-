            ...
            <div style="width: 970px;height: 500px;background:url(images/banner-bg.jpg) no-repeat center;overflow: scroll">
                ...
                <div style="width:83%;height: auto;float: right">
                    <center>
                        ...
                        s.setMessagee("Congratulations Mr/Mrs.  "+Applicant.getApplicant_From_ID(rs.getApp_id()).getNames()+"!! You have been selected for the mission.We will be contacted for more inforamtion soon");
                        s.setName(Applicant.getApplicant_From_ID(rs.getApp_id()).getNames());
                        s.setSubject("Test");
                        s.setTo(Applicant.getApplicant_From_ID(rs.getApp_id()).getEmail());
                                    %>
                        ...
                        s.setMessagee("Sorry  "+Applicant.getApplicant_From_ID(rs.getApp_id()).getNames()+", You are not selected for the this mission! You had: "+rs.getGrade()+" Points!!!");
                        s.setName(Applicant.getApplicant_From_ID(rs.getApp_id()).getNames());
                        s.setSubject("Test");
                        s.setTo(Applicant.getApplicant_From_ID(rs.getApp_id()).getEmail());
