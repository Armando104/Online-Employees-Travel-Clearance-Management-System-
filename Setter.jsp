        ...
        <center>
            ...
            <div style="width: 970px;height: 300px;background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <img src="" width="640" height="480" alt="" style="height: 300px;width: 400px;"/>
                </center>
            </div>
            <!--
...
Email:info@mod.rw</P>                      </div>
                ...
                <div class="panel border-right">
                    <div class="title">
                        ...
                        <div class="content">
                            <p style="color: white"><a style="color: white" target="_blank" href="Piechart.jsp">Applicant Statistics</a></p>
