    ...
    <body>
            ...
            <div class="row">
                ...
                <div class="menu" style="width: auto;float: right">
                    <ul>
                        ...
                        <li><a href="ApplicantView.jsp">All Candidates</a></li>
        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <p style="color: greenyellow"><%=po%></p>
                    <table border="1">
        <thead>
            <tr>
                <th>QUESTION ID</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><%=ll.get(j).getExam_Code() %></td>
                <td><%=ll.get(j).getMarks() %></td>

                <td><a href="deleteQuest.jsp?id=<%=ll.get(j).getId()%>">DELETE</a></td>
