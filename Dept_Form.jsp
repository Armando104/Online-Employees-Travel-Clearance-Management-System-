...
<jsp:useBean id="de" scope="request" class="pack.Department"></jsp:useBean>
<%@page import="pack.*"%>
        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <p style="color: #9cff00;margin-bottom: -10px;background-color: black">${de.msg}</p>
                    
                    <form method="POST" style="padding-top:10px;" action="deptAction.jsp">
                        ...
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="text" name="department_name" value="${de.department_name}" required=""/>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 50px;height: 30px" type="submit" name="op" value="${de.op}" readonly="readonly" />
                                    </td>
                                </tr> 
                            </tbody>
                        </table>
                                    <a href="Dept_View.jsp" style="color: #000">DEPARTMENT VIEW</a>
                    </form>
                </center>
            </div>
            <!--
