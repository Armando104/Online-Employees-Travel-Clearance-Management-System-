...
<jsp:useBean id="hd" scope="request" class="pack.HospitalDepartment"></jsp:useBean>
<%@page import="pack.*"%>
        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 5px;padding-top: 5px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <p style="color: #9cff00;margin-bottom: -10px;background-color: black">${hd.msg}</p>
                    
                    <form method="POST" style="padding-top:10px;" action="hospdeptAction.jsp">
                            ...
                            <tbody>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        ...
                                        <%
                                            List<Hospital> l = Hospital.getHospitalList();
                                            int i = 0;
                                        %>
                                        <select name="hospID" style="width: 205px;">
                                            <%
                                                while (i < l.size()) {
...
//                                                    String jj=sp.getHospital_name();
                                            %>
                                            <option value="<%=l.get(i).getHospital_id()%>">
                                                <%=l.get(i).getHospital_name() %>
                                            </option>
                                            <%
                                    ...
                                    <td>
                                        ...
                                        <%
                                            List<Department> ll = Department.getDepartmentist();
                                            int ii = 0;
                                        %>
                                        <select name="deptID" style="width: 205px;">
                                            <%
                                                while (ii < ll.size()) {
                                                    //int hdi=l.get(i).getHospital_id();
//                                                    Hospital sp=Hospital.getHospital_From_ID(hdi);
...
//                                                    String jj=sp.getHospital_name();
                                            %>
                                            <option value="<%=ll.get(ii).getDepartment_id() %>">
                                                <%=ll.get(ii).getDepartment_name() %>
                                            </option>
                                            <%
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 50px;height: 30px" type="submit" name="op" value="${hd.op}" readonly="readonly" />
                                    </td>
                                </tr> 
                            </tbody>
                        </table>
