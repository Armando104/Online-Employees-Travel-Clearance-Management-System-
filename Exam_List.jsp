    ...
    <body>
        ...
        <tbody>
            <%
                ...
                List<ExamClass> ll=ExamClass.getList();
                
                int j = 0;
                while (j < ll.size()) {
                    //List<Applicant> lo = Applicant.getListFrom_ID(ll.get(j).getApplicantId());
                    //int mem=ll.get(j).getBattaion_members();
            %>
            <tr>
                <td><%=ll.get(j).getId()%></td>
                <td><%=ll.get(j).getTitle()%></td>
                <td><%=ll.get(j).getExamTime()%></td>
                <td><%=Department.getDept_From_ID(ll.get(j).getDepartment()).getDepartment_name() %></td>
                <td><%=ll.get(j).getExamDate() %></td>
                
                <td><a href="deleteExam.jsp?id=<%=ll.get(j).getId()%>">DELETE</a></td>
                <td><a href="editExam.jsp?id=<%=ll.get(j).getId()%>">EDIT</a></td>
