...
//                        }
                    ...
                    <p style="color: #9cff00;margin-bottom: -10px;background-color: black">${d.msg}</p>

                    <form method="POST" style="padding-top:10px;" action="SelectAction.jsp">
                        ...
                        <table border="0">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 200px;height: 18px" type="hidden" name="selecteeID" value="${d.selecteeID}" required=""/>
                                        <input style="width: 200px;height: 18px" type="hidden" name="appID" value="${d.appID}" required=""/>
                                        <input style="width: 200px;height: 18px" type="hidden" name="userID" value="${d.userID}" required=""/>
                                        <input style="width: 200px;height: 18px" type="hidden" name="NOT" value="${d.NOT}" required=""/>
                                        <input style="width: 200px;height: 18px" type="hidden" name="RecDate" value="${d.recDate}" required=""/>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <%
                                            List<Battallion> l = Battallion.getBattallionList();
                                            int i = 0;
                                        %>
                                        <select name="battID" style="width: 220px;height: 18px">
                                            <%
                                                while (i < l.size()) {
                                                    
                                            %>
                                            <option value="<%=l.get(i).getBattallion_id()%>">
                                                <%=l.get(i).getBattallion_name()%>
                                            </option>
                                            <%
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 200px;" type="date" name="start_date" value="${d.start_date}" style="height: 18px;" />
                                    </td>
                                        <td style="color: red">${d.missionStartDate_msg}</td>
                                </tr> 
                                <tr>
                                    <td>
                                    ...
                                    <td>
                                        <input style="width: 200px;" type="date" name="end_date" value="${d.end_date}" style="height: 18px;" />
                                       
                                    </td>
                                        <td style="color: red">${d.missionEndDate_msg}</td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input style="width: 50px;height: 30px" type="submit" name="op" value="${d.op}" readonly="readonly" />
                                    </td>
                                </tr> 
                            </tbody>
                        </table>
