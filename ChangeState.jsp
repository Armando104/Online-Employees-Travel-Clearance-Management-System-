        ...
        <center>
            ...
            <div style="width: 970px;padding-bottom: 6px;padding-top: 2px; background:url(images/banner-bg.jpg) no-repeat center;">
                <center>
                    ...
                    <p style="color: #9cff00;margin-bottom: 3x;background-color: black"><%=dd.getMsg() %></p>

                    <form  style="padding-top:10px;" action="ChangeStateProcess.jsp">

                        <table border="0">
                            <tbody>
                                <input type="hidden" name="applicantId" value="<%=applicantId%>" required="" style="height: 18px;" />
                                       <tr>
                                    <td>
                                        Reason to be Disqualify
                                    </td>
                                    <td>
                                        <input style="width: 200px;" type="text" name="stateDescription"   style="height: 18px;" />
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="submit" name="op" value="Confirm" class="btn btn-inverse" />
                                    </td>
                                </tr> 
                            </tbody>
                        </table>
